                    ...
                    SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          StreamBuilder(
                            stream: getIt
                                .get<ListenToConversationsWithMessages>()
                                .call(),
                              ...
                              return Column(
                                ...
                                children: [
                                  _Subtitle(
                                      ...
                                      isExpanded:
                                          startedConversationsIsExpanded,
                                      toggleExpand: (expand) {
                                        setState(() {
                                          startedConversationsIsExpanded =
                                              expand;
                          ...
                          StreamBuilder(
                            ...
                            builder: (context, snapshotContacts) {
                              ...
                              final contacts = snapshotContacts.data!
                                  ...
                                  .where((element) =>
                                      element.userId !=
                                      getIt.get<AuthenticateService>().userId);
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).pushNamed(ScreenRoutes.chat,
            arguments:
                RealtimeChatScreenArgs(userId: userId, fullName: fullName));
      },
      child: Ink(
        child: Container(
          decoration: BoxDecoration(
              color: Colors.blue[100]!.withOpacity(.15),
              borderRadius: BorderRadius.circular(20)),
          padding:
              const EdgeInsets.only(top: 12, right: 18, left: 18, bottom: 6),
          child: Column(
            children: [
              Row(
                        ...
                        Row(
                          children: [
                            Text(fullName,
                                ...
                                style: TextStyle(
                                    fontWeight: unreadMessagesAmount == 0
                                        ? FontWeight.w600
                                        : FontWeight.w700,
                                    fontSize: 18,
                                    color: Colors.white)),
