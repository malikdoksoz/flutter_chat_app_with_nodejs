  ...
  Future<void> start() async {
    if (!_appStarted) {
      ...
      AsklessClient.instance
          .addOnReceiveCallListener((ReceivingCall receivingCall) {
        ...
        getIt.get<UsersRepo>().readUser(receivingCall.remoteUserId).then((res) {
          res.fold((l) {
            ...
            Navigator.of(navigatorKey.currentContext!).pushNamed(
                ScreenRoutes
                    .requestCall, // global context is used to jump to the call page
...
void Function() _onAutoReauthenticationFails = () {
